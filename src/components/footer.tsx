...
export function Footer() {
  return (
    <footer className="bg-leconte-primary p-8 gap-12 grid md:grid-cols-3  md:pd-12">
      <Link href="/" className="flex flex-1" title="Retour à l'accueil">
        <Image
      ...
      <div className="m-auto text-base text-center py-8 md:py-0 md:col-span-full">
