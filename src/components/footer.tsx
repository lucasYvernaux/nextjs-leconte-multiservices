    ...
    <footer className="bg-leconte-primary p-8 w-full md:h-[32vh] flex flex-col md:pd-12">
      <div className="flex gap-8 size-full flex-10 flex-col md:flex-row">
        ...
        <div className="flex flex-col gap-4 flex-1">
          <h2 className="text-3xl text-center md:text-start">Services</h2>
          <p className="text-xl">
        ...
        <div className="text-start flex flex-col gap-4 flex-1">
          <h2 className="text-3xl text-center md:text-start ">Contact</h2>
          <a
            href="tel:0640141937"
      ...
      <div className="text-base py-8 flex-1 flex items-end justify-center md:py-0">
